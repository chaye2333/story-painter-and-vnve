...
本项目对两个项目进行了联动尝试，中间联动代码由gemini3编写
↓↓↓
在文本处理后可以选择导入视频编辑器，可以自动生成对话，可以打断点，之后可以直接在网站上进行编辑和导出视频。
vnve提供手机端也可以编辑的兼容性，并且支持语音配音，只需在设置那边添加你所用语音模型的地址和key。
